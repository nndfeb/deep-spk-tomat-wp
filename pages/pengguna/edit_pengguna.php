...
<div class="container">
    ...
    ?>
        ...
        <form class="form" action="" method="post">
            ...
            <div class="btn-control">
                <button type="reset" onclick="location.href='index.php'" class="trigger" style="background-color: lightgray"><b>
                        <</b> </button> </div> </form> <script src="../../../public/assets/js/main.js">
                            </script>
                        <?php endwhile ?>
            </div>